...
class ORAMDataFixture16 : public benchmark::Fixture
{
public:
    size_t n;
    ...
    void SetUp(const ::benchmark::State &state) override
    {
        ...
        oram = new ORAM::ObliviousRAM<size_t,
                                      ORAM::Block<IndexType,
                                                  16 - sizeof(IndexType)>>(raw_data.begin(),
                                                                           raw_data.end());
    }
...
BENCHMARK_DEFINE_F(ORAMDataFixture16, ORAM)
...
BENCHMARK_REGISTER_F(ORAMDataFixture16, ORAM)->Apply(CustomizedArgsN)->MeasureProcessCPUTime()->UseRealTime();
