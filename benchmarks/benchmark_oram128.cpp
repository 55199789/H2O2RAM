...
public:
    ...
    std::vector<ORAM::Block<IndexType, 128 - sizeof(IndexType)>>
        raw_data;
    std::random_device rd;
    ORAM::ObliviousRAM<size_t, ORAM::Block<IndexType, 128 - sizeof(IndexType)>> *oram;
    void SetUp(const ::benchmark::State &state) override
    {
        ...
        oram = new ORAM::ObliviousRAM<size_t,
                                      ORAM::Block<IndexType,
                                                  128 - sizeof(IndexType)>>(raw_data.begin(),
                                                                           raw_data.end());
    }
...
BENCHMARK_REGISTER_F(ORAMDataFixture128, ORAM)->Apply(CustomizedArgsN)->MeasureProcessCPUTime()->UseRealTime();
